...
let log_info_func file_name = fun str -> Bolt.Logger.log "logger" Bolt.Level.INFO str ~file: file_name
let log_warn_func file_name = fun str -> Bolt.Logger.log "logger" Bolt.Level.WARN str ~file: file_name
let log_error_func file_name = fun str -> Bolt.Logger.log "logger" Bolt.Level.ERROR str ~file: file_name
let log_fatal_func file_name = fun str -> Bolt.Logger.log "logger" Bolt.Level.FATAL str ~file: file_name
